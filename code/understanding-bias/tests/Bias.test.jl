@testset "Bias" begin
    ...
    @testset "Basic functioning" begin
        weat_idx_set_1 = Bias.get_weat_idx_set(Bias.WEAT_WORD_SETS["science_arts"], M.vocab)
        weat_idx_set_2 = Bias.get_weat_idx_set(Bias.WEAT_WORD_SETS["instruments_weapons"], M.vocab)
